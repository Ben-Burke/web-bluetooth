...
BLEIntCharacteristic           OxygenCharacteristic  (MY_UUID("0010"), BLERead | BLEWrite);
BLEIntCharacteristic           HeartRateCharacteristic (MY_UUID("0011"), BLERead | BLEWrite);


BLEIntCharacteristic           MaxTemperatureCharacteristic  (MY_UUID("0020"), BLERead | BLEWrite);
BLEIntCharacteristic           HandTemperatureCharacteristic  (MY_UUID("0021"), BLERead | BLEWrite);
BLEIntCharacteristic           BreathTemperatureCharacteristic  (MY_UUID("0022"), BLERead | BLEWrite);

BLEIntCharacteristic           PressureCharacteristic  (MY_UUID("0030"), BLERead | BLEWrite);
...
// start the BLE radio:
  ...
  examin_service.addCharacteristic(OxygenCharacteristic);
  examin_service.addCharacteristic(MaxTemperatureCharacteristic);
  examin_service.addCharacteristic(HandTemperatureCharacteristic);
  examin_service.addCharacteristic(BreathTemperatureCharacteristic);
  examin_service.addCharacteristic(PressureCharacteristic);
  examin_service.addCharacteristic(HeartRateCharacteristic);
  ...
  MaxTemperatureCharacteristic.writeValue(0);
  HandTemperatureCharacteristic.writeValue(0);
  BreathTemperatureCharacteristic.writeValue(0);
